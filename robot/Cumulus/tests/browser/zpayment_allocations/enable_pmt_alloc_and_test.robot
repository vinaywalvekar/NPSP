...
Create Payment Allocations and Verify Opportunity Allocations Sync
    ...
    [tags]                                 W-039821            feature:payment_allocations
    Go To Page                             Details
    ...                                    Opportunity
...
Enable Payment Allocations
    [Documentation]       Enables Default and Payment Allocations and sets a default GAU in  custom settings
...
Disable Payment Allocations
    [Documentation]       Disables Default and Payment Allocations and removes default GAU in  custom settings
    Go To Page                      Custom                                  CustomSettings
    Select Settings Option          Allocations Settings                    Manage
    Verify Page And Select Frame    Allocations Settings
    Wait Until Element Is Visible   text:Default Organization Level Value
...
Setup Test Data
    [Documentation]       Creates the GAU, Contants, Opportunities and Payments records
    &{GAU} =              API Create GAU
